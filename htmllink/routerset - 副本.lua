...
function listap(t)
    local aplist = "<h2>Please Select a SSID</h2>"
   ...
   -- conn:send(string.sub(aplist,1,string.len(aplist)/2))
   -- conn:send(string.sub(aplist,string.len(aplist)/2+1,string.len(aplist)))
    
    conn:send(form)
    conn:send(js)
    --conn:send("\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r") 
    conn:close()
